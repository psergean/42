...
/*   Updated: 2017/10/04 19:49:21 by psergean         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		display(t_env *env)
{
	...
	mlx_string_put(env->mlx, env->win, 10, 80, 0x00FFFFFF, "Lapin_de_douady : l");
	...
	mlx_string_put(env->mlx, env->win, 10, 160, 0x00FFFFFF, "Iteration : i : o");
	mlx_string_put(env->mlx, env->win, 10, 180, 0x00FFFFFF, "Zoom : + : -");
	mlx_string_put(env->mlx, env->win, 10, 200, 0x00FFFFFF, "Reset : r");
	mlx_string_put(env->mlx, env->win, 10, 220, 0x00FFFFFF, "Quit : Esc");
}
